...
class RangeInputGUI:
    def __init__(self, master):
        ...
        heading.grid(row=0, column=0, columnspan=3, pady=10)
        self.gbr_button_GBR = tk.Button(self.output_frame, text="Gradient Boosting Regressor (BR)", command=self.calculate_G_Bagging_regressor,
    ...
    def calculate_G_Bagging_regressor(self):
        ...
        try:
            print("Starting Gradient Boosting regressor density calculation...")
            base_dir = r"C:\Users\MUHAMMAD SAUD KHAN\Documents\Waleed\software-and-prediction-main\GPC Version 1 (GBR)\GPC Variant 1 (GBR)"
            ...
            regressor = BaggingRegressor(n_estimators=60, bootstrap=True)
